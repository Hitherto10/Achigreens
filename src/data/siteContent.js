...
export const products = [
  {
    id: 1,
    name: 'Tomato',
    description: 'Fresh, juicy, and rich in flavor, our farm-grown tomatoes are perfect for sauces, salads, and everyday cooking',
    price: '420/kg',
    image: Images.tomato,
    category: 'Vegetable',
  },
  {
    id: 2,
    name: 'Radish',
    description: 'Crisp and refreshing with a peppery bite, our radishes add a crunchy freshness to any dish.',
    price: '1500/kg',
    image: Images.radish,
    category: 'Spice',
  },
  {
    id: 3,
    name: 'Bell Peppers',
    description: 'Vibrant and sweet, our bell peppers come in a variety of colors, ideal for stir-fries, salads, and grilling.',
    price: '6500/kg',
  ...
  },
  {
    id: 4,
    name: 'Bitter Gourd',
    description: 'Nutritious and distinct in taste, our fresh bitter gourds are ideal for traditional dishes and herbal health recipes.',
    price: '3620/kg',
  ...
  },
  {
    id: 5,
    name: 'Corn',
    description: 'Naturally sweet and tender, our golden corn is harvested at peak freshness for maximum flavor and nutrition.',
    price: '450/kg',
    image: Images.corn,
    category: 'Starchy',
  },
  {
    id: 6,
    name: 'Ginger',
    description: 'Aromatic and full of zest, our fresh ginger is perfect for seasoning, teas, and wellness remedies',
    price: '1650/kg',
