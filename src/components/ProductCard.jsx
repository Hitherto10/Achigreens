...
function ProductCardBase({ product, handlePlaceOrder }) {
  return (
        ...
        <div className="flex flex-wrap gap-3 items-center justify-between">
          <span className="text-xl sm:text-2xl font-bold text-gray-900">₦{product.price}</span>
            <button
                ...
                className="px-3 py-2 sm:px-4 bg-green-500 text-white rounded-full hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2 transition-all"
